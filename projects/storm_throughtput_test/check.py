...
class StormCheck:
    ...
    def update_from_config(self):
        ...
        self.nimbus_server = "http://192.168.99.100:8080"
    ...
    def check(self):
        ...
        try:
            ...
            print("nimbus_summary:", nimbus_stats)
        ...
        try:
            ...
            print("supervisor_stats:", supervisor_stats)
            ...
            if topology_name not in self.excluded_topologies:
                for interval in self.intervals:
                    try:
                        ...
                        print("topology_metric:", metric_stats)
    ...
    def check_topology_acked(self, server, topology_id, window=600):
        """
        :param topology_id:
           id of topology to check
        :param window:
            window of check, default is 600
        :return:
        """
        self.nimbus_server = server
        self.environment_name = "test"
        self.additional_tags = []
        self.excluded_topologies = []

        try:
            stats = self.get_topology_info(topology_id=topology_id, interval=window)
            # print("topology_stats:", stats)
            self.process_topology_stats(topology_stats=stats, interval=window)
            acked_tuples = _get_long(stats, 0, 'topologyStats', 0, 'acked')
            return acked_tuples
    ...
    def check_topology_transferred(self, server, topology_id, window=600):
        """
        :param topology_id:
           id of topology to check
        :param window:
        ...
        try:
            ...
            # print("topology_stats:", stats)
            self.process_topology_stats(topology_stats=stats, interval=window)
            transfered_tuples = _get_long(stats, 0, 'topologyStats', 0, 'transferred')
            return transfered_tuples
        except Exception as e:  # noqa
            # self.log.exception(
            #     "unable to collect topology stats for topology_id:{}, topology_name:{}".format(
            #         topology_id, topology_name
